...
| Feature | Where | Roadmap id | What it does | Setting | Default | On by default? |
|---|---|---|---|---|---|---|
| Batch summarisation of old turns | `src/workers/batch_summarizer.py:24` | G11 | Groups at least5 eligible old turns by token budget; original attributed notes require NLI support, otherwise complete source survives. Fingerprinted manifests detect edits/deletions; stale caches rebuild. | — | — | YES |
