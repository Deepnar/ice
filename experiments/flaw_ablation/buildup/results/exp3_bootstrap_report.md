...
|-----------|------:|:------:|:-------:|
| add_bm25 | -0.74 | [-1.14, -0.36] | **yes** |
| add_rrf | +0.09 | [-0.18, +0.34] | no |
| add_hyde | +0.12 | [-0.15, +0.37] | no |
| add_cluster_restrict | +0.13 | [-0.13, +0.39] | no |
| add_session_diversify | +0.13 | [-0.15, +0.42] | no |
| add_codex | +0.16 | [-0.10, +0.43] | no |
| add_mera | -0.04 | [-0.36, +0.27] | no |
| add_procedural | +0.12 | [-0.15, +0.37] | no |
| add_batch_summary | +0.11 | [-0.23, +0.44] | no |
| add_dynamic_budget | +0.03 | [-0.25, +0.30] | no |
| add_sliding_window | +0.03 | [-0.27, +0.33] | no |
| add_keyword_boost | +0.17 | [-0.20, +0.53] | no |
...
|----------|--:|:------:|--:|:-------:|
| bm25_damage (add_bm25 - bare_vector) | -0.74 | [-1.14, -0.36] | 66 | **yes** |
| rrf_rescue (add_rrf - add_bm25) | +0.82 | [+0.39, +1.24] | 66 | **yes** |
| rrf_vs_bare (add_rrf - bare_vector) | +0.09 | [-0.18, +0.34] | 67 | no |
| full_ice_vs_bare (full_ice - bare_vector) | +0.09 | [-0.24, +0.42] | 66 | no |
| full_ice_vs_vecbaseline (full_ice - vector_baseline) | -0.06 | [-0.38, +0.25] | 63 | no |
