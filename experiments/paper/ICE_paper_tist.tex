%=====================================================================
% ⛔ FROZEN RECORD — DO NOT EDIT. This is exactly what ACM TIST received.
%
% Submitted 2026-08-01 as TIST-2026-08-0869; REJECTED 2026-08-28 at the
% editorial/AE stage without external review ("Comments to Author(s) by
% Reviewer(s)" came back empty). "The decision is final, and we cannot
% consider any appeals."
%
% Kept unedited for the same reason as docs/ICE_Architecture[real_v2].md:
% it is the historical record of what was actually judged. Fixes arising
% from the reject go into `ICE_paper_v2.tex` (canonical), NOT here.
% PUBLISHING.md §3's "change substantive content in both" rule applied
% only while the TIST submission was live.
%=====================================================================
...
% The evaluated code is git tag v2-paper-eval (0521df9 since the 2026-08-03
% history rewrite; it was e4019b6 before, and that SHA no longer resolves --
% same tree 2990066b, so the evaluated code is unchanged). The system as
