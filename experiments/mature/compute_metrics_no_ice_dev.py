...
OUTPUT_FILE    = os.path.join(RESULTS_DIR, "metrics_complete_report_no_ice_dev.json")
...
def compute_metrics(master_entries, eval_dict):
    ...
    gating_failures = []
    ICE_DEV_CID = "a77c15cf-2078-4279-aeaa-8c3a6d58a972"
    ...
    report = {
        ...
        "research_integrity_metadata": {
            "experiment_id": "ICE-MATURE-PHASE-2-NO-ICE-DEV",
